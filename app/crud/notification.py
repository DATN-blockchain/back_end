...
class CRUDNotification(CRUDBase[Notification, NotificationCreate, NotificationUpdate]):
    ...
    @staticmethod
    def list_notifications(db: Session, user_id: str, unread: bool, skip: int = None, limit: int = None):
    ...
    @staticmethod
    def list_notifications_unread(db: Session, user_id: str, skip: int = None, limit: int = None):
    ...
    @staticmethod
    def mark_notification_as_read(db: Session, current_notification: Notification, unread: bool):
    ...
    @staticmethod
    def create_multi_notification(db: Session, list_request_data: list):
