...
class AppStatus(Enum):
    ...
    ERROR_INVALID_QUANTITY = status.HTTP_400_BAD_REQUEST, 400, 'INVALID_QUANTITY'
    ...
    ERROR_PLEASE_ADD_KG_TYPE = status.HTTP_400_BAD_REQUEST, 400, 'PLEASE_ADD_KG_TYPE'
    ERROR_PLEASE_ADD_DATA = status.HTTP_400_BAD_REQUEST, 400, 'PLEASE_ADD_DATA'
    ERROR_YOU_BALANCE_IS_INSUFFICIENT = status.HTTP_400_BAD_REQUEST, 400, 'YOU_BALANCE_IS_INSUFFICIENT'
    ERROR_YOU_CANNOT_ADD_TO_CART = status.HTTP_400_BAD_REQUEST, 400, 'YOU_CANNOT_ADD_TO_CART'
    ERROR_ORDER_IS_COMPLETED = status.HTTP_400_BAD_REQUEST, 400, 'ORDER_IS_COMPLETED'
    ERROR_YOU_HAVE_NOT_CLASSIFIED_GOODS_YET = status.HTTP_400_BAD_REQUEST, 400, 'YOU_HAVE_NOT_CLASSIFIED_GOODS_YET'
    ...
    ERROR_TRANSACTION_UNSUCCESSFUL = status.HTTP_400_BAD_REQUEST, 400, "ERROR_TRANSACTION_UNSUCCESSFUL"
    ...
    ERROR_YOUR_ACCOUNT_LOCKED = status.HTTP_401_UNAUTHORIZED, 401, 'YOUR_ACCOUNT_LOCKED'
    ...
    ERROR_CLASSIFY_GOODS_METHOD_NOT_ALLOWED = (status.HTTP_405_METHOD_NOT_ALLOWED, 405,
                                               'CLASSIFY_GOODS_METHOD_NOT_ALLOWED')
    ...
    ERROR_CLASSIFY_GOODS_CONFLICT = status.HTTP_409_CONFLICT, 409, 'CLASSIFY_GOODS_ALREADY_EXIST'
